...
coordinaten= pd.read_csv('coordinaten.csv',delimiter=';') 
...
if selection == "Home: Overview of NYC AirBnB Data":
    ...
    st.subheader("Price distribution per burrow")
    st.markdown("""
    ...
    st.subheader("Top 25 most expensive and cheapest neighbourhoods")
    st.markdown("""
